...
class EMR:
    ...
    def load_model(self):
        if isfile("C:/Users/ashis/PycharmProjects/Py/emot/source/model_1_nimish.tflearn.meta"):
            self.model.load("C:/Users/ashis/PycharmProjects/Py/emot/source/model_1_nimish.tflearn")
